...
try:
    ...
    print("\n[WARNING] OpenCL device enumeration failed.")
    print("[INFO] Continuing without OpenCL.")
    print("[INFO] Reason:", e)

    ALL_CL_DEVICES = OrderedDict()
    ALL_CL_DEVICES['None'] = None
...
#        print("useZMQ:", self.useZMQ)
        ...
        if isOpenCL and not self.useZMQ:
            ...
            print("\n[INFO] OpenCL/ZMQ unavailable.")
            print("[INFO] Continuing in CPU-only compatibility mode.")

            targetOpenCL = None
            self.useZMQ = False

            self.cl_precisionF = float
            self.cl_precisionC = complex
